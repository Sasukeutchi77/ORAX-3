    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 animate-in fade-in duration-200">
      ...
      >
                ...
                <div className="space-y-1.5">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <VerifiedBadge 
                      ...
                      size="md" 
                      showLabel={true} 
                      labelText={devInfo.isLordDemon ? 'Fondateur NEXORA' : 'Développeur Certifié'} 
                    />
                  </div>
                    ...
                    <p className="text-[11px] text-zinc-400 mt-0.5">
                      {certStats.isCertified
                        ? (certStats.isLordDemon 
                            ? 'Compte fondateur & développeur officiel certifié NEXORA.'
        ...
        <div className="p-4 sm:p-5 border-t border-zinc-800 bg-zinc-950 flex items-center justify-between text-xs text-zinc-500 font-mono">
          <span>NEXORA • Communauté de Développeurs</span>
          <button
            onClick={onClose}
